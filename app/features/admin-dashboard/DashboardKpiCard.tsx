...
export default function DashboardKpiCard({ card, index = 0 }: DashboardKpiCardProps) {
  ...
  const wrapperClass =
    "group relative overflow-hidden rounded-2xl border border-white/10 bg-[var(--dp-surface-low)]/85 p-5 transition-all duration-300 hover:-translate-y-0.5 hover:border-[color-mix(in_srgb,var(--dp-primary)_45%,transparent)]";
